...
/// <summary>
/// Victory screen selection arrow controller.
/// Handles keyboard navigation for 2 options:
///   0 = Restart
///   1 = Quit
/// Mirrors GameOverSelectionArrow.
/// </summary>
public class WinSelectionArrow : MonoBehaviour
{
    ...
    private void Interact()
    {
        ...
        {
            Debug.LogError("WinController is NOT assigned in WinSelectionArrow!");
            return;
        }
        ...
        {
            case RESTART:
                winController.RestartGame();
                break;
            case QUIT:
                winController.QuitGame();
                break;
        }
    }
